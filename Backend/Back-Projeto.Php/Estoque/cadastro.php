...
if (isset($_POST['id_Entrada']) && isset($_POST['cod_Produto']) && isset($_POST['qtd_Estoque'])) {
    $id_Entrada = $_POST['id_Entrada'];
    $cod_Produto = $_POST['cod_Produto'];
    $qtd_Estoque = $_POST['qtd_Estoque'];

    // Verifica se o id_Entrada já existe no banco de dados
    $check_id_sql = "SELECT * FROM estoque WHERE id_Entrada = '$id_Entrada'";
    ...
    if (mysqli_num_rows($result_id) > 0) {
        ...
        // Inserção de novos dados com os campos id_Entrada, cod_Produto e qtd_Estoque
        $sql = "INSERT INTO estoque (id_Entrada, cod_Produto, qtd_Estoque) VALUES ('$id_Entrada', '$cod_Produto', '$qtd_Estoque')";
