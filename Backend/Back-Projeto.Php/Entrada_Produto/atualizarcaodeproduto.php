...
<body>
    ...
    $sql = "SELECT id_Entrada, id_Usuario, nome_Usuario, id_Fornecedor, razao_social, cod_Produto, nome_Produto, id_Estoque, qtd_Entrada, preco_Custo, sub_Grupo, valor_Total, data_Entrada FROM entrada_produtos";
...
<form action="atualizar.php" method="POST" class="center-form">
    ...
    <label for="NOVOrazao_social">Nome do Fornecedor:</label>
    <input type="text" name="NOVOrazao_social" id="NOVOrazao_social"  class="form-control" required>
    <br>
