...
<?php
    ...
    $razao_social = $_POST['NOVOrazao_social']; // Razão Social
    ...
    // s: string (nome_Usuario, razao_social, cod_Produto, nome_Produto, sub_Grupo, data_Entrada)
    // d: decimal (preco_Custo, valor_Total)
    $stmt->bind_param("sssssssssssss", $id_Usuario, $nome_Usuario, $id_Fornecedor, $razao_social, $cod_Produto, $nome_Produto, $id_Estoque, $qtd_Entrada, $preco_Custo, $sub_Grupo, $valor_Total, $data_Entrada, $id_Entrada);
